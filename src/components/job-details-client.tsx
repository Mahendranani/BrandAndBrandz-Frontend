            ...
            <main className="relative z-10 pt-24 px-4 sm:px-6 lg:px-8 pb-20">
                <div className="max-w-4xl mx-auto space-y-12">
                    ...
                    >
                        <Button
                            disabled
                            className="w-full sm:w-auto min-w-[200px] bg-gradient-to-r from-blue-600 to-sky-400 text-white rounded-full py-6 text-lg font-semibold shadow-lg shadow-blue-500/20 transition-all duration-300 transform hover:scale-105 cursor-not-allowed opacity-90 hover:from-blue-600 hover:to-sky-400"
                        >
                            Apply Now
                        </Button>
                    </motion.div>
